...
void mainmenu(void)
{
	system("cls");
	printf("                                 **************************************************************************\n");
	printf("                                                     WELCOME TO ONLINE SHOPPING SYSTEM\n");
	printf("                                 **************************************************************************\n\n\n");
...
void vegetarian(void)
{
	...
	printf("                    ****************************************\n                                  ART SUPPLIES\n                    ****************************************\n\n");
	//printf("      1. Paint Brush               40/-\n      2. Canvas              60/-\n      3. Paint             45/-\n      4. Colored pencils            35/-\n      5. Art set          150/-\n         -->Pencil and eraser\n         -->Watercolor Paint\n         -->Brush\n         -->Watwrcolor paper\n         -->Palette\n      6. Back To Main Menu\n\n Enter Your Choice-->  ");
	char v;
	FILE *vmenu;
	
    vmenu=fopen("art.txt","rt");
...
void nonvegetarian(void)
{
	...
	double price=0;
	printf("                                    **********************************************\n");
	printf("                                                  CRAFT SUPPLIES\n");
	printf("                                    **********************************************\n");
     //	printf("1. Colored Paper            100-\n\n2. Scissors          50-\n\n3. Glue        85-\n\n4. Markers              135-\n\n5. Back To Main Menu\n\n\nEnter Your Choice");
	char n;
	FILE *nmenu;
	nmenu = fopen("craft.txt","rt");
...
void details(void)
{
	...
	printf("\n\n\n");
	printf("                       *********************************************************************************************\n");
	printf("                                                       Your Order Will Be At Your Door.\n");
